...
//   const { currentRoom, isInRoom, isConnected, isSpeaker, isMuted, roomDuration } = useSelector(
//     (state: RootState) => state.audioroom
//   );
//   const { leaveRoom } = useAudioRoom();

//   // Don't show floating window if user is already on audioroom pages
//   if (!isInRoom || !currentRoom || location.pathname.startsWith('/audioroom')) {
//     return null;
//   }
